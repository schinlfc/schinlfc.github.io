...
description: "We estimate well-being among older rural Americans using an expected utility framework that incorporates differences in consumption, leisure, health, mortality, and wealth using data from the Health and Retirement Study (HRS). Work in Progress, 2023." 
summary: "We estimate well-being among older rural Americans using an expected utility framework that incorporates differences in consumption, leisure, health, mortality, and wealth using data from the Health and Retirement Study (HRS). We find that older rural Americans are generally falling further behind older urban American across birth cohorts. Most of this widening gap is also driven by declining relative consumption and QALE." 
cover:
    image: "/3.jpg"
    alt: "Regional variation in consumption, QALE, aggreate welfare, and welfare rural-urban ratio"
    relative: false
editPost:
